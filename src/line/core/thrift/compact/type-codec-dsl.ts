...
export const COMPACT_TYPE_CODEC_DEFINITIONS: CompactTypeCodecDefinition[] = [
  {
    ...
    writeHandler: 'writeBoolValue',
  },
  {
    type: THRIFT_TYPE.BYTE,
    readHandler: 'readByteValue',
    writeHandler: 'writeByteValue',
  },
  {
    type: THRIFT_TYPE.I16,
    readHandler: 'readI16Value',
    writeHandler: 'writeI16Value',
  },
  {
    type: THRIFT_TYPE.I32,
    readHandler: 'readI32Value',
    writeHandler: 'writeI32Value',
  },
  {
    type: THRIFT_TYPE.I64,
    readHandler: 'readI64Value',
    writeHandler: 'writeI64Value',
  },
  {
    type: THRIFT_TYPE.STRING,
    readHandler: 'readStringValue',
    writeHandler: 'writeStringValue',
  },
] as const
 ...
 */
export function getCompactTypeCodecDefinition(
  type: number,
): CompactTypeCodecDefinition | null {
  return (
    COMPACT_TYPE_CODEC_DEFINITIONS.find(
